...
def get_filters():
    ...
    """
    print("\nWhich city do you want? New York City, Chicago or Washington?")
    ...
    while True:
        ...
        if city in ['chicago', 'new york city', 'washington'] :
            print('continue')
            print("Which month do you want? January, February, March, April, May, June or type 'all'")
            break
    else:
    ...
    while True:
        ...
        if month in ['january','february','march','april','may','june','all']:
            print('continue')
            print ('choose one day from the following list or all : saturday, sunday, monday, tuesday, wednesday, thursday, or, friday')
            break
    else:
